...
public class BenevolentStrategy implements Strategy {
	...
	/**
	 * This method finds the weakest country of a player which is the country with
	 * lowest no. of armies out of all the countries which can be attacked by the
	 * other players.
	 * 
	 * @param map        Map Object
	...
	public void fortification(Map map, ArrayList<Player> listPlayer, String command, Player P) {
		...
		if (max > 1) {
			...
			System.out.println(
					"Cannot fortify as all the neighboring countries of weakest country have only 1 army left");
		P.setEndOfActions(1);
